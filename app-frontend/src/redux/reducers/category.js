import { ADD_CATEGORY_SUCCESS, CLOSE_CATEGORY_MODAL, EDIT_CATEGORY_SUCCESS, FETCH_ALL_CATEGORY_SUCESS, OPEN_CATEGORY_MODAL, REMOVE_CATEGORY_SUCCESS, RESET_CATEGORY, RESET_PRODUCT } from "../actionTypes";
